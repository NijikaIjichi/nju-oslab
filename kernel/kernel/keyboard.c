...
static uint32_t keyBuffer[MAX_KEYBUFFER_SIZE];
static int bufferHead;
static int bufferTail;
static int buffer_enter;
...
void initKeyTable() {
	...
	keyTableL[KBAC_P]='\b'; keyTableU[KBAC_P]='\b';
}
